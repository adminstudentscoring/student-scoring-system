...
function main() {
  ...
  // Build Monster Fight module by transforming the existing file.
  ...
  // Remove the aggregator registration block inside the function.
  ...
  // Build games entry / aggregator (keep old exported name for compatibility).
