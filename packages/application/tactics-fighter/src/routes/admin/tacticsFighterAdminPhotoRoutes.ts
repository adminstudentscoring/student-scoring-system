// Tactics Fighter teacher photo recognize routes
"use strict";

function registerTacticsFighterAdminPhotoRoutes(app: any, deps: any, shared: any): void {
...
module.exports = { registerTacticsFighterAdminPhotoRoutes };
export {};
